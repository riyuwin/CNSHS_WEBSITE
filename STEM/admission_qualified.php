    ...
    if(isset($_SESSION['user_id']) && isset($_SESSION['email'])) {
        ...
        if ($result) {
            if (isset($row['user_id'])) {
                if ($row['user_id'] === $user_id && $row['status'] === 'Qualified') {
                    //echo 'found!';
...
<head>
    ...
    <link href="css/admission_qualified.css" rel="stylesheet">
    ...
    <div class="admission_status_container">
        <div class="admission_content_container">
            ...
            <div>
                ...
                <p>We are pleased to inform you that you are <strong>QUALIFIED FOR ADMISSION</strong> at <strong>Camarines Norte Senior High School</strong> for School Year 2023 - 2024 for the strand:</p>
