...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <br>
    <div class="breadcrumbs flex align-items-center" style="background-image: url('assets/img/student_life/dance6.png');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">

        <h2><span>CNSHS</span> Folkdance </h2>
        <ol>
          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/student_life/dance1.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/student_life/dance2.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/student_life/dance3.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/student_life/dance4.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/student_life/dance5.jpg" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Folkdance</h2>
              <p>
                STEM education does not only focuses in Sciences and Math, we value Arts such as Dance and Performances, and its Historical significance to our culture as Filipinos.
              </p>
              <p>
                Part of their wholistic development is to nurture their involvement in other areas of learning, these Grade 12 learners showcased their excellence by perfoming Folkdance as one of their activities in PE.
                Job well done, STEMNIANS
              </p>

              <div class="testimonial-item">
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  "STEM education should not limit itself to Science and Math, as it also recognizes the significance of Arts and culture in a student's overall growth and development. The incorporation of dance and performance in PE activities is a testament to the wholistic approach in nurturing STEM learners."
          ...
          <div class="col-lg-3">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Event Date</strong> <span>21 October, 2022</span></li>
