...
<body>
    ...
    <header>
        ...
        <div class="header_container_whitebg">
            ...
            <div class="garments_text_container">
                <a href="garmnents.php" style="text-decoration: none; color: black;"><p>GARMENTS</p></a>
            </div>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <br>
    <div class="breadcrumbs flex align-items-center" style="background-image: url('assets/img/student_life/blog.png');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">

        <h2><span>CNSHS</span> Disaster and Risk Reduction Management</h2>
        <ol>
          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/student_life/blog-3.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/student_life/blog-4.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/student_life/blog-5.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/student_life/blog-6.jpg" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Disaster and Risk Reduction Management</h2>
              <p>
                ...
                After the Drill, the school's Disaster Risk Reduction (DRR) adviser, Sir Elias Yago, along with the School's DRR Officers, oriented all the students about the increasing number of earthquakes and the importance of being prepared for such disasters.
               
              </p>
              <p>
                According to Sir Yago, the increasing number of earthquakes in the Philippines is a cause for concern, and it is important for everyone to be prepared for such disasters. He stressed the importance of having an emergency plan in place and being equipped with basic survival skills.
                In Camarines Norte Senior High School, the earthquake drill was a success, and the students and teachers were able to demonstrate their readiness and preparedness in case of an actual earthquake. As the Philippines continues to face natural disasters, it is important for everyone to remain vigilant and prepared.
              ...
              <div class="testimonial-item">
                <p>
                  ...
                  "Resilience is not just about surviving a disaster, it's about how we come together as a community to rebuild and recover."
          ...
          <div class="col-lg-3">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Event Date</strong> <span>16 March, 2023</span></li>
