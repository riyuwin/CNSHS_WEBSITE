...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <br>
    <div class="breadcrumbs flex align-items-center" style="background-image: url('assets/img/student_life/bag.png');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">

        <h2><span>NO BAG FOR A DAY?</span> CHALLENGE ACCEPTED!</h2>
        <ol>
          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/student_life/bag1.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/student_life/bag2.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/student_life/bag3.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/student_life/bag4.jpg" alt="">
              </div>

              <div class="swiper-slide">s
                <img src="assets/img/student_life/bag5.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/student_life/bag6.jpg" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              ...
              <p>
                The Grade 11 learners at Camarines Norte Senior Highschool have taken on a unique and creative challenge - the No Bag Challenge. 
                Instead of traditional backpacks, students have brought in an array of unconventional bags, ranging from baskets to boxes, to carry their school things. 
                This initiative not only promotes creativity but also encourages students to think outside the box and find alternative solutions to everyday problems. 
                By challenging the norm, these students have created a sense of community and camaraderie within their grade level, fostering a culture of innovation and individuality. 
                Overall, the No Bag Challenge at Camarines Senior Highschool is a testament to the power of unconventional thinking and the value of promoting creativity in education.
              </p>
                <div class="testimonial-item">
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  "Embrace the challenge of standing out from the crowd. Let your creativity and individuality shine through, just like these students who dared to carry their school things in unique and unconventional bags."
          ...
          <div class="col-lg-3">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Event Date</strong> <span>16 September, 2022</span></li>
