    ...
    <div class="admission_container">
        ...
        <div class="personal_info_container">
            ...
            <div class="grid-container">
                ...
                <div><p  style="margin:1%; ">Welcome to the Senior High School Admission System for Incoming Grade 11 Students! This streamlined process empowers you to embark on an exciting educational journey. Discover a comprehensive and transparent system that ensures a fair selection process. From submitting your application to providing necessary documents, we strive to make the admission process smooth and efficient. Our dedicated team is here to assist you in understanding the requirements and guiding you through each step. Whether it's attending interviews or entrance exams, we are committed to providing a supportive environment where you can showcase your skills and talents. By participating in this admission system, you'll have the opportunity to secure your spot in the Senior High School program, unlocking a world of academic and personal growth.<br><br>

                As an incoming Grade 11 student, the Senior High School program offers you a transformative experience. It provides a dynamic and well-rounded education, allowing you to explore diverse subjects, develop specialized skills, and prepare for higher education or career pathways. Our admission system aims to identify students who are passionate, driven, and ready to embrace the challenges and opportunities that await them in Senior High School.  <br><br>
                </p>
                </div> 
            </div>
        </div>
