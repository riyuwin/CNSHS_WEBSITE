...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <br>
    <div class="breadcrumbs flex align-items-center" style="background-image: url('assets/img/alumni/news_alum1.png');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">

        <h2><span>CNSHS</span> Class Alimbukad</h2>
        <ol>
          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/alumni/news2.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/alumni/new3.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/alumni/new5.jpg" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Alumni Alimbukad</h2>
              <p>
              Alumni Alimbukad is a prominent figure in Camarines Norte Senior High School's alumni community.
               Known for their exceptional academic achievements and leadership qualities, Alumni Alimbukad has left an indelible mark on the school's legacy.
              </p>
              <p>
              During their time at Camarines Norte Senior High School, Alumni Alimbukad displayed a strong dedication to their studies, consistently earning top 
              grades and demonstrating a thirst for knowledge. Their commitment to academic excellence served as an inspiration to fellow students and earned them the respect of both peers and faculty.
              </p>
