...
<head>
    <title>CNSHS - Testimonies Verification</title>
    ...
    <link href="css/testimonies_verification_proc.css" rel="stylesheet">
    ...
    <div class="admission_form_container">
        <div class="admission_header_container">
            ...
            <div class="admission_content_container">
                <h6>CNSHS Alumni Testimonies</h6>
            </div>
            
            
            <div class="label_container">
                <h1>Alumni Testimonies Information</h1>
            </div>
            <div class="btn_categories_container">
                <p>Categories:    
                    ...
                    <form method='post'>
                        ...
                        <button  class='m-1 h-10 btn btn-light' name='confirmed'>Confirmed</button>    
                        <button  class='m-1 h-10 btn btn-light' name='deleted'>Deleted</button>  
                    </form>";
                    ...
                    <tbody>
                        <?php  
                            ...
                            if (isset($_POST['deleted'])) { 
                                $sql = "SELECT * FROM testimonies WHERE `status`='Deleted'";
                            } else if (isset($_POST['confirmed'])) { 
                                $sql = "SELECT * FROM testimonies WHERE `status`='Confirmed'";
                            } else if (isset($_POST['pending'])) { 
                                $sql = "SELECT * FROM testimonies WHERE `status`='Pending'";
                            ...
                            while($row = $result->fetch_assoc()){
                                echo "<tr>
                                    ...
                                    <td>". $row['status'] ."</td> 
                                    <td>
                                        <a class='btn btn-primary'  href='php/testimonies_verification_proc.php?confirmid=" . $row['tes_id'] ."'>Confirm</a>
                                        <a class='btn btn-danger' href='php/testimonies_verification_proc.php?deleteid=" . $row['tes_id'] ."'>Delete</a>
                                    </td> 
                                    </tr>";
                                } 
                        ?>
