...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <br>
    <div class="breadcrumbs flex align-items-center" style="background-image: url('assets/img/alumni/news_alum2.png');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">

        <h2><span>CNSHS</span> Class Hiraya</h2>
        <ol>
          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/alumni/new6.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/alumni/new7.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/alumni/new8.jpg" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>Alumni Hariya</h2>
              <p>
              Alumni Alimbukad's remarkable leadership skills were recognized and appreciated by their classmates and teachers.
               They demonstrated a natural ability to motivate and inspire others, taking on leadership roles in school projects, group activities,
                and community initiatives. Their dedication to making a positive impact in their school and local community was truly commendable.</p>
              <p>
              Even after graduating from Camarines Norte Senior High School, Alumni Alimbukad continues to be an inspiration to current students.
               Their achievements serve as a testament to the quality education and values instilled by the school, and they have become an esteemed role model for future generations of students.</p>
