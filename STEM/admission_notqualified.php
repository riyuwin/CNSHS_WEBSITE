    ...
    if(isset($_SESSION['user_id']) && isset($_SESSION['email'])) {
        ...
        if ($result) {
            if (isset($row['user_id'])) {
                if ($row['user_id'] === $user_id && $row['status'] === 'Not Qualified') {
                    //echo 'found!';
...
<head>
    <title>CNSHS - Admission Qualified</title>
    ...
    <link href="css/admission_notqualified.css" rel="stylesheet">
    ...
    <div class="admission_status_container">
        <div class="admission_content_container">
            ...
            <div>
                ...
                <h1>Notice</h1>
                <p>We are sad to inform you that you are <strong>NOT QUALIFIED FOR ADMISSION</strong> at <strong>Camarines Norte Senior High School</strong> for School Year 2023 - 2024 for the strand Science, Technology, Engineering, and Mathematics</p>
            </div> 
        </div>
    </div>
...
<?php
            //this conditional statement is for the applicant status
                ...
                exit();
            } else  if ($row['user_id'] === $user_id && $row['status'] === 'Pending'){
                echo 'You are pending!'; 
