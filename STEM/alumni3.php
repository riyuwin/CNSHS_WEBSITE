...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <br>
    <div class="breadcrumbs flex align-items-center" style="background-image: url('assets/img/alumni/news3.png');">
      <div class="container position-relative d-flex flex-column align-items-center" data-aos="fade">

        <h2><span>CNSHS</span>MEMORADUM OF AGREEMENT</h2>
        <ol>
          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/alumni/memo1.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/alumni/memo2.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="assets/img/alumni/memo3.jpg" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              <h2>MEMORADUM OF AGREEMENT</h2>
              <p>
              A Memorandum of Agreement (MOA) is a formal document that establishes the terms and conditions of a cooperative agreement or partnership between two or more parties.
               In the case of Camarines Norte Senior High School (CNSHS) and Camarines Norte State College (CNSC), an MOA serves as a framework for 
               collaboration and cooperation between the two educational institutions.
               <p>
               The MOA between CNSHS and CNSC outlines the specific areas of collaboration, mutual goals, and responsibilities of each party involved.
                It may cover various aspects such as academic programs, research initiatives, faculty development, student exchange programs, infrastructure 
                sharing, and other areas of mutual interest.</p>
              <div class="testimonial-item">
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  "Together, we rise, inspired by the roots that grounded us and the wings that propel us towards success."
